...
class _DeliveryScreenState extends State<DeliveryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(title: const Text("Enter Delivery Information")),
        resizeToAvoidBottomInset: false,
        body: Row(
          children: [
            if (_mediaQuery.size.width > 600) const SideNavBar(),
            Container(
              width: _mediaQuery.size.width > 600
                  ? _mediaQuery.size.width * 0.9
                  : _mediaQuery.size.width,
              child: Padding(
                padding: EdgeInsets.symmetric(
                    horizontal: _mediaQuery.size.width > 600
