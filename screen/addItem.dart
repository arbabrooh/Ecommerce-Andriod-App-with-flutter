...
class AddItem extends StatefulWidget {
  ...
  const AddItem({Key? key, this.navKey}) : super(key: key);
...
class _AddItemState extends State<AddItem> {
  ...
  File? _productImage; ////File _productImage;
...
// handling _saveForm with async style
  Future<void> _saveForm() async {
    ...
    await ref.putFile(_productImage!).whenComplete(() async {
    ...
    return Scaffold(
        ...
        body: _isLoading
            ...
            : Padding(
                ...
                child: Form(
                    key: _formKey, //giving form a key for efficient operation
                    child:
                      ...
                      DropdownButtonFormField(
                        ...
                        items: categoryItems.map((String item) {
                          return DropdownMenuItem(
                              onTap: () {}, child: Text(item), value: item);
                        }).toList(),
                      ),
                      TextFormField(
