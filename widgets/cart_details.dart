    ...
    return Dismissible(
        ...
        confirmDismiss: (direction) {
          ...
          return showDialog(
              context: context,
              builder: (context) {
                return AlertDialog(title: Text("Are you sure?"), content: Text("Do you want to remove this item?"), actions: [
                  TextButton(
                      child: Text("YES"),
                      onPressed: () {
        ...
        background: Container(color: theme.errorColor, padding: EdgeInsets.all(11), child: Icon(Icons.delete, color: Colors.white), alignment: Alignment.centerRight),
        child: Card(
          elevation: 5,
          child: Padding(
              padding: EdgeInsets.all(5),
              child: Row(children: [
                Container(width: deviceWidth * 0.1, child: CircleAvatar(child: FittedBox(child: Text("₦${widget.price * widget.quantity}")))),
                Container(
                    width: deviceWidth * 0.6,
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
                      FittedBox(child: Text(widget.title, style: TextStyle(fontWeight: FontWeight.bold))),
                      SizedBox(width: 5),
